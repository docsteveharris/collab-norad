...
Figure 2 (Bottom panel): Standardised regression coefficients for patient level predictors of 24 hour treatment variables (noradrenaline dose, mean arterial pressure, and fluid balance). The point estimates are surrounded by black and grey limits representing one and two standard error limits. For MAP, the standard errors were so large that the x-axis scale has been extended to four standardised coefficients above and below zero.

![](figures/model_rx_all.jpg)

## Figure 3

Figure 3: Standardised regression coefficients for patient level predictors of ICU mortality. Each predictor is scaled and so the relative effects are directly comparable, and Noradrenaline dose at 24 hours is the strongest predictor of mortality. Increasing heart rates are also associated with worse outcomes but this affect is attenuated as the noradrenaline dose increases (see the negative effect for the Noradrenaline:Heart rate interaction term). The point estimates are surrounded by black and grey limits representing one and two standard error limits.

![](figures/model_mortality.jpg)

## Figure 4

Figure 4: Model predictions of mortality against noradrenaline dose at 24 hours repeated for patients with high (>95/min) and low heart rates. Noradrenaline has a weaker association with mortality for patients with a higher 24 hour heart rate (lower slope).

![](figures/model_mortality_ne24hr24.jpg)
...
Standardised regression coefficients for patient level predictors of 24 hour treatment variables (noradrenaline dose, mean arterial pressure, and fluid balance).
