...
# - duplicated from table1_byHosp.R
...
# Define file name
table1.file <- '../outputs/tables/table1_byNorad.xlsx'

# Define strata
# NOTE: 2014-10-13 - analyse all
wdt$ne.1.cut	<- cut2(wdt$ne.1, c(0.1, 0.3))
describe(wdt$ne.1.cut)
vars.strata <-  'ne.1.cut'
